...
export default function AddTouristSpot() {
  ...
  return (
    <>
      ...
      <section className="p-6 dark:text-gray-900 my-14">
        <form
          noValidate=""
          action=""
        ...
        >
          <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-base-100">
            <div className="space-y-2 col-span-full lg:col-span-1">
              <p className="font-medium text-lg text-[#fcb040] ">
                <span className="text-[#4b5664]">Add</span> tourists{" "}
                <span>spot</span>{" "}
              </p>
              <p className="text-xs text-[#4b5664]">
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <label htmlFor="photo" className="block text-sm">
                ...
                required
                  ...
                  className="w-full px-3 py-2 border outline-none rounded-md bg-transparent border-gray-300 text-gray-800 focus:ring-1 focus:ring-[#fcb040]"
                />
              </div>
              <div className="col-span-full sm:col-span-3">
          ...
          <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-base-100">
            <div className="space-y-2 col-span-full lg:col-span-1">
              <p className="font-medium text-lg text-[#fcb040] ">
                <span className="text-[#4b5664]">Per</span>sonal information{" "}
              </p>
              <p className="text-xs text-[#4b5664] ">
                {" "}
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <div className="col-span-full md:col-span-2 lg:col-span-1 mt-5    ">
                ...
                <button
                  ...
                  className="relative w-full px-5 py-3 overflow-hidden font-bold text-gray-600  border border-[#13131326] rounded-lg shadow-inner group"
                >
