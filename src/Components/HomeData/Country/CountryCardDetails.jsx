...
export default function CountryCardDetails({data}) {
    const{theme} = useContext(AuthContext)
 
  console.log(data);
    const {photo,spot,country,description,cost,_id,seasonality,location} = data||{};
  return (
    <>
     ...
     {description.slice(0,88)}...
      ...
      <div className="mt-5 ">
        ...
        data-aos-duration="2000"
          to={`/cardDetails/${_id}`}
          className="relative inline-flex items-center justify-start px-3 py-2  overflow-hidden  border border-[#fcb040] font-medium transition-all bg-white rounded hover:bg-white group"
        >
