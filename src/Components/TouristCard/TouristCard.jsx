...
export default function TouristCard({data}) {
    ...
    const {photo,spot,country,description,cost,_id,time,seasonality,visitor} = data||[];
  return (
    <>
      <div 
      data-aos="zoom-in-up"
       ...
       {description.slice(0,90)}...
        ...
        <div className="mt-5 ">
          ...
          data-aos-duration="2000"
            to={`/cardDetails/${_id}`}
            className="relative inline-flex items-center justify-start px-3 py-1 overflow-hidden  border border-[#fcb040] font-medium transition-all bg-white rounded hover:bg-white group"
          >
